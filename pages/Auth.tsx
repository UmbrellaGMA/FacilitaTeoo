                ...
                <div className="md:w-1/2 p-12 flex flex-col justify-center bg-white dark:bg-[#1a141f]">
                    <div className="mb-10 text-center md:text-left">
                        <h3 className="text-3xl font-black text-[#161118] dark:text-white mb-2">
                            {isRegistering ? 'Crie sua conta' : 'Boas-vindas de volta'}
                        </h3>
                        <p className="text-[#7c6189] dark:text-purple-200/60 font-medium">
                            {isRegistering
                                ? 'Comece a transformar seus eventos hoje mesmo.'
                                : 'Acesse seu painel administrativo para continuar.'}
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleAuth} className="space-y-5">
                        ...
                        <button
                            disabled={loading}
                            type="submit"
                            className="w-full bg-primary text-white font-black py-4 rounded-2xl shadow-xl shadow-primary/30 hover:bg-primary-hover transition-all active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-3 group"
                        >
                            {loading ? (
